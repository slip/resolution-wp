<?php
/**
 * ResolutionAthens functions and definitions
 *
...
function resolutionathens_setup() {
	 ...
	 * If you're building a theme based on ResolutionAthens, use a find and replace
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'resolutionathens' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'resolutionathens_custom_background_args', array(
 ...
 */
function resolutionathens_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'resolutionathens' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'resolutionathens' ),
...
add_action( 'widgets_init', 'resolutionathens_widgets_init' );
...
function resolutionathens_scripts() {
	...
	wp_enqueue_script( 'resolutionathens-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'resolutionathens-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
